...
import ErrorSuggestion from "../components/bottomUpAnalisys/ErrorSuggestion";
    ...
    getAllData(
      ...
      .then((response) => {
        if (response.data["ERROR_CODE"] == 0) {
          ...
          // Verificar se há erro nos passos
          const lastStep = response.data["stepsParsing"][response.data["stepsParsing"].length - 1];
          if (lastStep && lastStep.error) {
            setErrorInfo(lastStep.error);
          }
        } else {
          navigate("/error", {
            state: {
          ...
          <div className="col-md-6">
            <div className="row">
              <div className="col-md-9">
                ...
                />
                {errorInfo && <ErrorSuggestion error={errorInfo} />}
              </div>
